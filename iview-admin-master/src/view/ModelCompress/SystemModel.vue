    ...
    <div>
      ...
      <card shadow>
        <Row>
          ...
          <Col span="3">
            <p class="head-font">{{ selectedValueClass }}</p>
          </Col>
        </Row>
        <Divider style="margin: 12px 0px" />
        <Row>
        <!-- 数据集以及分类 -->
        <compress-images v-bind:selected-value="selectedValueClass" v-on:update-selected-value="selectedValueClass = $event"></compress-images>
      ...
      <card size="large">
        ...
        <Row>
          ...
          <Button type="primary" style="margin-left: 45%">
            <a
              :href="'download-model/?model=' + compressStatus.ModelName"
              style="color: white"
              >下载模型
            </a>
          </Button>
